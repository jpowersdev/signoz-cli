...
it("agentInstructions stamps the version and documents the group-by footgun", () => {
  ...
  expect(md).toContain("signoz alerts triage")
  expect(md).toContain("signoz alerts evaluate")
  expect(md).toContain("signoz services operations")
  expect(md).toContain("signoz logs aggregate")
  expect(md).toContain("signoz traces search")
