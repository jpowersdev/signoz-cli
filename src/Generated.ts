...
export const AlertmanagertypesChannelGoogleChatConfig = Schema.Struct({ "sendResolved": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "text": Schema.optionalKey(Schema.String), "title": Schema.optionalKey(Schema.String), "webhookUrl": Schema.String.annotate({ "format": "password" }) })
...
export const AlertmanagertypesChannelIncidentIOConfig = Schema.Struct({ "description": Schema.optionalKey(Schema.String), "metadata": Schema.optionalKey(Schema.Record(Schema.String, Schema.String)), "sendResolved": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "title": Schema.optionalKey(Schema.String), "token": Schema.String.annotate({ "format": "password" }), "url": Schema.String })
...
export const AlertmanagertypesChannelJSMOpsConfig = Schema.Struct({ "apiKey": Schema.String.annotate({ "format": "password" }), "description": Schema.optionalKey(Schema.String), "message": Schema.optionalKey(Schema.String), "priority": Schema.optionalKey(Schema.String), "sendResolved": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "tags": Schema.optionalKey(Schema.String) })
...
export const AlertmanagertypesChannelJiraConfig = Schema.Struct({ "apiToken": Schema.String.annotate({ "format": "password" }), "customFields": Schema.optionalKey(Schema.Record(Schema.String, Schema.Json)), "description": Schema.optionalKey(Schema.String), "email": Schema.String, "issueType": Schema.String, "labels": Schema.optionalKey(Schema.Array(Schema.String)), "priority": Schema.optionalKey(Schema.String), "project": Schema.String, "reopenDuration": Schema.optionalKey(Schema.String), "reopenTransition": Schema.optionalKey(Schema.String), "resolveTransition": Schema.optionalKey(Schema.String), "sendResolved": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "site": Schema.String, "summary": Schema.optionalKey(Schema.String), "wontFixResolution": Schema.optionalKey(Schema.String) })
export type AlertmanagertypesChannelKind = "slack" | "email" | "webhook" | "pagerduty" | "opsgenie" | "msteams" | "googlechat" | "jira" | "jsmops" | "incidentio"
export const AlertmanagertypesChannelKind = Schema.Literals(["slack", "email", "webhook", "pagerduty", "opsgenie", "msteams", "googlechat", "jira", "jsmops", "incidentio"])
export type AlertmanagertypesChannelListOrder = "asc" | "desc"
export const AlertmanagertypesChannelListOrder = Schema.Literals(["asc", "desc"])
export type AlertmanagertypesChannelListSort = "updated_at" | "created_at" | "name"
export const AlertmanagertypesChannelListSort = Schema.Literals(["updated_at", "created_at", "name"])
...
export const AlertmanagertypesChannelMSTeamsConfig = Schema.Struct({ "sendResolved": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "text": Schema.optionalKey(Schema.String), "title": Schema.optionalKey(Schema.String), "webhookUrl": Schema.String.annotate({ "format": "password" }) })
...
export const AlertmanagertypesChannelPagerdutyConfig = Schema.Struct({ "class": Schema.optionalKey(Schema.String), "client": Schema.optionalKey(Schema.String), "clientUrl": Schema.optionalKey(Schema.String), "component": Schema.optionalKey(Schema.String), "description": Schema.optionalKey(Schema.String), "details": Schema.optionalKey(Schema.Record(Schema.String, Schema.String)), "group": Schema.optionalKey(Schema.String), "routingKey": Schema.String.annotate({ "format": "password" }), "sendResolved": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "severity": Schema.optionalKey(Schema.String), "source": Schema.optionalKey(Schema.String), "url": Schema.optionalKey(Schema.String) })
...
export const AlertmanagertypesChannelSlackConfig = Schema.Struct({ "apiUrl": Schema.String.annotate({ "format": "password" }), "channel": Schema.optionalKey(Schema.String), "sendResolved": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "text": Schema.optionalKey(Schema.String), "title": Schema.optionalKey(Schema.String) })
...
export const AlertmanagertypesChannelWebhookConfig = Schema.Struct({ "bearerToken": Schema.optionalKey(Schema.String.annotate({ "format": "password" })), "password": Schema.optionalKey(Schema.String.annotate({ "format": "password" })), "sendResolved": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "url": Schema.String.annotate({ "format": "password" }), "username": Schema.optionalKey(Schema.String) })
...
export type DashboardtypesHeaderOptions = { readonly "hide"?: boolean }
export const DashboardtypesHeaderOptions = Schema.Struct({ "hide": Schema.optionalKey(Schema.Boolean) })
...
export type DashboardtypesTextAlign = "left" | "center" | "right"
export const DashboardtypesTextAlign = Schema.Literals(["left", "center", "right"])
export type DashboardtypesTextMode = "markdown"
export const DashboardtypesTextMode = Schema.Literal("markdown")
...
export type DashboardtypesVerticalAlign = "top" | "center" | "bottom"
export const DashboardtypesVerticalAlign = Schema.Literals(["top", "center", "bottom"])
...
export type Querybuildertypesv5AggregationMeta = { readonly "buckets"?: ReadonlyArray<number>, readonly "unit"?: string }
export const Querybuildertypesv5AggregationMeta = Schema.Struct({ "buckets": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "double" }).check(Schema.isFinite()))), "unit": Schema.optionalKey(Schema.String) })
export type Querybuildertypesv5BucketsKind = "linear" | "log"
export const Querybuildertypesv5BucketsKind = Schema.Literals(["linear", "log"])
...
export type Querybuildertypesv5LinearBucketsSpec = { readonly "maxValue": number, readonly "numBuckets"?: number }
export const Querybuildertypesv5LinearBucketsSpec = Schema.Struct({ "maxValue": Schema.Number.annotate({ "format": "double" }).check(Schema.isFinite()), "numBuckets": Schema.optionalKey(Schema.Number.check(Schema.isInt())) })
export type Querybuildertypesv5LogBucketsSpec = { readonly "scale"?: number | null }
export const Querybuildertypesv5LogBucketsSpec = Schema.Struct({ "scale": Schema.optionalKey(Schema.Union([Schema.Number.check(Schema.isInt()), Schema.Null])) })
...
export type Querybuildertypesv5RequestType = "scalar" | "time_series" | "raw" | "raw_stream" | "trace" | "heatmap"
export const Querybuildertypesv5RequestType = Schema.Literals(["scalar", "time_series", "raw", "raw_stream", "trace", "heatmap"])
...
export type RuletypesAlertType = "METRIC_BASED_ALERT" | "TRACES_BASED_ALERT" | "LOGS_BASED_ALERT" | "EXCEPTIONS_BASED_ALERT" | "AI_TRACES_BASED_ALERT"
export const RuletypesAlertType = Schema.Literals(["METRIC_BASED_ALERT", "TRACES_BASED_ALERT", "LOGS_BASED_ALERT", "EXCEPTIONS_BASED_ALERT", "AI_TRACES_BASED_ALERT"])
...
export type AlertmanagertypesListedNotificationChannel = { readonly "createdAt": string, readonly "displayName": string, readonly "id": string, readonly "kind": AlertmanagertypesChannelKind, readonly "name": string, readonly "updatedAt": string }
export const AlertmanagertypesListedNotificationChannel = Schema.Struct({ "createdAt": Schema.String.annotate({ "format": "date-time" }), "displayName": Schema.String, "id": Schema.String, "kind": AlertmanagertypesChannelKind, "name": Schema.String, "updatedAt": Schema.String.annotate({ "format": "date-time" }) })
...
export type DashboardtypesTextPresentation = { readonly "background"?: string | null, readonly "textAlign"?: DashboardtypesTextAlign, readonly "verticalAlign"?: DashboardtypesVerticalAlign }
export const DashboardtypesTextPresentation = Schema.Struct({ "background": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "textAlign": Schema.optionalKey(DashboardtypesTextAlign), "verticalAlign": Schema.optionalKey(DashboardtypesVerticalAlign) })
...
export type Querybuildertypesv5BucketOptions = { readonly "kind": Querybuildertypesv5BucketsKind, readonly "spec": Querybuildertypesv5LinearBucketsSpec } | { readonly "kind": Querybuildertypesv5BucketsKind, readonly "spec": Querybuildertypesv5LogBucketsSpec }
export const Querybuildertypesv5BucketOptions = Schema.Union([Schema.Struct({ "kind": Querybuildertypesv5BucketsKind, "spec": Querybuildertypesv5LinearBucketsSpec }), Schema.Struct({ "kind": Querybuildertypesv5BucketsKind, "spec": Querybuildertypesv5LogBucketsSpec })], { mode: "oneOf" })
...
export type AlertmanagertypesListableNotificationChannel = { readonly "channels": ReadonlyArray<AlertmanagertypesListedNotificationChannel>, readonly "total": number }
export const AlertmanagertypesListableNotificationChannel = Schema.Struct({ "channels": Schema.Array(AlertmanagertypesListedNotificationChannel), "total": Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt()) })
...
export type AlertmanagertypesTestableNotificationChannel = { readonly "config": AlertmanagertypesChannelConfig }
export const AlertmanagertypesTestableNotificationChannel = Schema.Struct({ "config": AlertmanagertypesChannelConfig })
export type AlertmanagertypesUpdatableNotificationChannel = { readonly "config": AlertmanagertypesChannelConfig }
export const AlertmanagertypesUpdatableNotificationChannel = Schema.Struct({ "config": AlertmanagertypesChannelConfig })
...
export type DashboardtypesTextPanelSpec = { readonly "headerOptions"?: DashboardtypesHeaderOptions, readonly "mode"?: DashboardtypesTextMode, readonly "presentation"?: DashboardtypesTextPresentation, readonly "text"?: string }
export const DashboardtypesTextPanelSpec = Schema.Struct({ "headerOptions": Schema.optionalKey(DashboardtypesHeaderOptions), "mode": Schema.optionalKey(DashboardtypesTextMode), "presentation": Schema.optionalKey(DashboardtypesTextPresentation), "text": Schema.optionalKey(Schema.String) })
...
export type Querybuildertypesv5QueryBuilderFormula = { readonly "bucketOptions"?: Querybuildertypesv5BucketOptions, readonly "disabled"?: boolean, readonly "expression"?: string, readonly "functions"?: ReadonlyArray<{ readonly "args"?: ReadonlyArray<{ readonly "name"?: string, readonly "value"?: number | string }>, readonly "name"?: Querybuildertypesv5FunctionName }>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "name"?: string, readonly "order"?: ReadonlyArray<{ readonly "direction"?: Querybuildertypesv5OrderDirection, readonly "key"?: Querybuildertypesv5OrderByKey }> }
export const Querybuildertypesv5QueryBuilderFormula = Schema.Struct({ "bucketOptions": Schema.optionalKey(Querybuildertypesv5BucketOptions), "disabled": Schema.optionalKey(Schema.Boolean), "expression": Schema.optionalKey(Schema.String), "functions": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "args": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "name": Schema.optionalKey(Schema.String), "value": Schema.optionalKey(Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.String], { mode: "oneOf" })) }))])), "name": Schema.optionalKey(Querybuildertypesv5FunctionName) }))])), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "name": Schema.optionalKey(Schema.String), "order": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "direction": Schema.optionalKey(Querybuildertypesv5OrderDirection), "key": Schema.optionalKey(Querybuildertypesv5OrderByKey) }))])) })
export type Querybuildertypesv5QueryBuilderQueryGithubComSigNozSignozPkgTypesQuerybuildertypesQuerybuildertypesv5TraceAggregation = { readonly "aggregations"?: ReadonlyArray<{ readonly "alias"?: string, readonly "expression"?: string }>, readonly "bucketOptions"?: Querybuildertypesv5BucketOptions, readonly "cursor"?: string, readonly "disabled"?: boolean, readonly "filter"?: Querybuildertypesv5Filter, readonly "functions"?: ReadonlyArray<{ readonly "args"?: ReadonlyArray<{ readonly "name"?: string, readonly "value"?: number | string }>, readonly "name"?: Querybuildertypesv5FunctionName }>, readonly "groupBy"?: ReadonlyArray<{ readonly "description"?: string, readonly "fieldContext"?: TelemetrytypesFieldContext, readonly "fieldDataType"?: TelemetrytypesFieldDataType, readonly "name": string, readonly "signal"?: TelemetrytypesSignal, readonly "unit"?: string }>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "limitBy"?: Querybuildertypesv5LimitBy, readonly "name"?: string, readonly "offset"?: number, readonly "order"?: ReadonlyArray<{ readonly "direction"?: Querybuildertypesv5OrderDirection, readonly "key"?: Querybuildertypesv5OrderByKey }>, readonly "secondaryAggregations"?: ReadonlyArray<{ readonly "alias"?: string, readonly "expression"?: string, readonly "groupBy"?: ReadonlyArray<{ readonly "description"?: string, readonly "fieldContext"?: TelemetrytypesFieldContext, readonly "fieldDataType"?: TelemetrytypesFieldDataType, readonly "name": string, readonly "signal"?: TelemetrytypesSignal, readonly "unit"?: string }>, readonly "limit"?: number, readonly "limitBy"?: Querybuildertypesv5LimitBy, readonly "order"?: ReadonlyArray<{ readonly "direction"?: Querybuildertypesv5OrderDirection, readonly "key"?: Querybuildertypesv5OrderByKey }>, readonly "stepInterval"?: Querybuildertypesv5Step }>, readonly "selectFields"?: ReadonlyArray<{ readonly "description"?: string, readonly "fieldContext"?: TelemetrytypesFieldContext, readonly "fieldDataType"?: TelemetrytypesFieldDataType, readonly "name": string, readonly "signal"?: TelemetrytypesSignal, readonly "unit"?: string }>, readonly "signal": "traces", readonly "source"?: TelemetrytypesSource, readonly "stepInterval"?: Querybuildertypesv5Step }
export const Querybuildertypesv5QueryBuilderQueryGithubComSigNozSignozPkgTypesQuerybuildertypesQuerybuildertypesv5TraceAggregation = Schema.Struct({ "aggregations": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "alias": Schema.optionalKey(Schema.String), "expression": Schema.optionalKey(Schema.String) }))])), "bucketOptions": Schema.optionalKey(Querybuildertypesv5BucketOptions), "cursor": Schema.optionalKey(Schema.String), "disabled": Schema.optionalKey(Schema.Boolean), "filter": Schema.optionalKey(Querybuildertypesv5Filter), "functions": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "args": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "name": Schema.optionalKey(Schema.String), "value": Schema.optionalKey(Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.String], { mode: "oneOf" })) }))])), "name": Schema.optionalKey(Querybuildertypesv5FunctionName) }))])), "groupBy": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "description": Schema.optionalKey(Schema.String), "fieldContext": Schema.optionalKey(TelemetrytypesFieldContext), "fieldDataType": Schema.optionalKey(TelemetrytypesFieldDataType), "name": Schema.String, "signal": Schema.optionalKey(TelemetrytypesSignal), "unit": Schema.optionalKey(Schema.String) }))])), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "limitBy": Schema.optionalKey(Querybuildertypesv5LimitBy), "name": Schema.optionalKey(Schema.String), "offset": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "order": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "direction": Schema.optionalKey(Querybuildertypesv5OrderDirection), "key": Schema.optionalKey(Querybuildertypesv5OrderByKey) }))])), "secondaryAggregations": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "alias": Schema.optionalKey(Schema.String), "expression": Schema.optionalKey(Schema.String), "groupBy": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "description": Schema.optionalKey(Schema.String), "fieldContext": Schema.optionalKey(TelemetrytypesFieldContext), "fieldDataType": Schema.optionalKey(TelemetrytypesFieldDataType), "name": Schema.String, "signal": Schema.optionalKey(TelemetrytypesSignal), "unit": Schema.optionalKey(Schema.String) }))])), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "limitBy": Schema.optionalKey(Querybuildertypesv5LimitBy), "order": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "direction": Schema.optionalKey(Querybuildertypesv5OrderDirection), "key": Schema.optionalKey(Querybuildertypesv5OrderByKey) }))])), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) }))])), "selectFields": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "description": Schema.optionalKey(Schema.String), "fieldContext": Schema.optionalKey(TelemetrytypesFieldContext), "fieldDataType": Schema.optionalKey(TelemetrytypesFieldDataType), "name": Schema.String, "signal": Schema.optionalKey(TelemetrytypesSignal), "unit": Schema.optionalKey(Schema.String) }))])), "signal": Schema.Literal("traces"), "source": Schema.optionalKey(TelemetrytypesSource), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) })
...
export type MetricsexplorertypesInspectMetricsResponse = { readonly "series": ReadonlyArray<{ readonly "labels"?: ReadonlyArray<Querybuildertypesv5Label>, readonly "values"?: ReadonlyArray<{ readonly "partial"?: boolean, readonly "timestamp"?: number, readonly "value"?: SignoztypesFloat64, readonly "values"?: ReadonlyArray<SignoztypesFloat64> }> }> }
export const MetricsexplorertypesInspectMetricsResponse = Schema.Struct({ "series": Schema.Union([Schema.Array(Schema.Struct({ "labels": Schema.optionalKey(Schema.Array(Querybuildertypesv5Label)), "values": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "partial": Schema.optionalKey(Schema.Boolean), "timestamp": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "value": Schema.optionalKey(SignoztypesFloat64), "values": Schema.optionalKey(Schema.Array(SignoztypesFloat64)) }))])) }))]) })
export type Querybuildertypesv5TimeSeries = { readonly "labels"?: ReadonlyArray<Querybuildertypesv5Label>, readonly "values"?: ReadonlyArray<{ readonly "partial"?: boolean, readonly "timestamp"?: number, readonly "value"?: SignoztypesFloat64, readonly "values"?: ReadonlyArray<SignoztypesFloat64> }> }
...
export type ListNotificationChannelsParams = { readonly "query"?: string, readonly "kind"?: AlertmanagertypesChannelKind, readonly "sort"?: AlertmanagertypesChannelListSort, readonly "order"?: AlertmanagertypesChannelListOrder, readonly "limit"?: number, readonly "offset"?: number }
export const ListNotificationChannelsParams = Schema.Struct({ "query": Schema.optionalKey(Schema.String), "kind": Schema.optionalKey(AlertmanagertypesChannelKind), "sort": Schema.optionalKey(AlertmanagertypesChannelListSort), "order": Schema.optionalKey(AlertmanagertypesChannelListOrder), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "offset": Schema.optionalKey(Schema.Number.check(Schema.isInt())) })
export type ListNotificationChannels200 = { readonly "data": AlertmanagertypesListableNotificationChannel, readonly "status": string }
export const ListNotificationChannels200 = Schema.Struct({ "data": AlertmanagertypesListableNotificationChannel, "status": Schema.String })
export type ListNotificationChannels400 = RenderErrorResponse
export const ListNotificationChannels400 = RenderErrorResponse
export type ListNotificationChannels401 = RenderErrorResponse
export const ListNotificationChannels401 = RenderErrorResponse
export type ListNotificationChannels403 = RenderErrorResponse
export const ListNotificationChannels403 = RenderErrorResponse
export type ListNotificationChannels500 = RenderErrorResponse
export const ListNotificationChannels500 = RenderErrorResponse
...
export type GetNotificationChannel200 = { readonly "data": AlertmanagertypesGettableNotificationChannel, readonly "status": string }
export const GetNotificationChannel200 = Schema.Struct({ "data": AlertmanagertypesGettableNotificationChannel, "status": Schema.String })
export type GetNotificationChannel400 = RenderErrorResponse
export const GetNotificationChannel400 = RenderErrorResponse
export type GetNotificationChannel401 = RenderErrorResponse
export const GetNotificationChannel401 = RenderErrorResponse
export type GetNotificationChannel403 = RenderErrorResponse
export const GetNotificationChannel403 = RenderErrorResponse
export type GetNotificationChannel404 = RenderErrorResponse
export const GetNotificationChannel404 = RenderErrorResponse
export type GetNotificationChannel500 = RenderErrorResponse
export const GetNotificationChannel500 = RenderErrorResponse
export type UpdateNotificationChannelRequestJson = AlertmanagertypesUpdatableNotificationChannel
export const UpdateNotificationChannelRequestJson = AlertmanagertypesUpdatableNotificationChannel
export type UpdateNotificationChannel200 = { readonly "data": AlertmanagertypesGettableNotificationChannel, readonly "status": string }
export const UpdateNotificationChannel200 = Schema.Struct({ "data": AlertmanagertypesGettableNotificationChannel, "status": Schema.String })
export type UpdateNotificationChannel400 = RenderErrorResponse
export const UpdateNotificationChannel400 = RenderErrorResponse
export type UpdateNotificationChannel401 = RenderErrorResponse
export const UpdateNotificationChannel401 = RenderErrorResponse
export type UpdateNotificationChannel403 = RenderErrorResponse
export const UpdateNotificationChannel403 = RenderErrorResponse
export type UpdateNotificationChannel404 = RenderErrorResponse
export const UpdateNotificationChannel404 = RenderErrorResponse
export type UpdateNotificationChannel500 = RenderErrorResponse
export const UpdateNotificationChannel500 = RenderErrorResponse
export type DeleteNotificationChannel400 = RenderErrorResponse
export const DeleteNotificationChannel400 = RenderErrorResponse
export type DeleteNotificationChannel401 = RenderErrorResponse
export const DeleteNotificationChannel401 = RenderErrorResponse
export type DeleteNotificationChannel403 = RenderErrorResponse
export const DeleteNotificationChannel403 = RenderErrorResponse
export type DeleteNotificationChannel404 = RenderErrorResponse
export const DeleteNotificationChannel404 = RenderErrorResponse
export type DeleteNotificationChannel500 = RenderErrorResponse
export const DeleteNotificationChannel500 = RenderErrorResponse
export type TestNotificationChannelRequestJson = AlertmanagertypesTestableNotificationChannel
export const TestNotificationChannelRequestJson = AlertmanagertypesTestableNotificationChannel
export type TestNotificationChannel400 = RenderErrorResponse
export const TestNotificationChannel400 = RenderErrorResponse
export type TestNotificationChannel401 = RenderErrorResponse
export const TestNotificationChannel401 = RenderErrorResponse
export type TestNotificationChannel403 = RenderErrorResponse
export const TestNotificationChannel403 = RenderErrorResponse
export type TestNotificationChannel500 = RenderErrorResponse
export const TestNotificationChannel500 = RenderErrorResponse
...
export type GetRuleHistoryTopContributors200 = { readonly "data": ReadonlyArray<{ readonly "count": number, readonly "fingerprint": number, readonly "labels": ReadonlyArray<{ readonly "key"?: TelemetrytypesTelemetryFieldKey, readonly "value"?: string | number | boolean }>, readonly "relatedAITracesLink"?: string, readonly "relatedLogsLink"?: string, readonly "relatedTracesLink"?: string }>, readonly "status": string }
export const GetRuleHistoryTopContributors200 = Schema.Struct({ "data": Schema.Union([Schema.Array(Schema.Struct({ "count": Schema.Number.check(Schema.isInt()).check(Schema.isGreaterThanOrEqualTo(0)), "fingerprint": Schema.Number.check(Schema.isInt()).check(Schema.isGreaterThanOrEqualTo(0)), "labels": Schema.Union([Schema.Array(Schema.Struct({ "key": Schema.optionalKey(TelemetrytypesTelemetryFieldKey), "value": Schema.optionalKey(Schema.Union([Schema.String, Schema.Number.check(Schema.isFinite()), Schema.Boolean], { mode: "oneOf" })) }))]), "relatedAITracesLink": Schema.optionalKey(Schema.String), "relatedLogsLink": Schema.optionalKey(Schema.String), "relatedTracesLink": Schema.optionalKey(Schema.String) }))]), "status": Schema.String })
...
export const make = (
  ...
  return {
    ...
    "ListNotificationChannels": (options) => HttpClientRequest.get(`/api/v2/notification_channels`).pipe(
    HttpClientRequest.setUrlParams({ "query": options?.params?.["query"] as any, "kind": options?.params?.["kind"] as any, "sort": options?.params?.["sort"] as any, "order": options?.params?.["order"] as any, "limit": options?.params?.["limit"] as any, "offset": options?.params?.["offset"] as any }),
    withResponse(options?.config)(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(ListNotificationChannels200),
      "400": decodeError("ListNotificationChannels400", ListNotificationChannels400),
      "401": decodeError("ListNotificationChannels401", ListNotificationChannels401),
      "403": decodeError("ListNotificationChannels403", ListNotificationChannels403),
      "500": decodeError("ListNotificationChannels500", ListNotificationChannels500),
      orElse: unexpectedStatus
    }))
  ),
    ...
    "GetNotificationChannel": (id, options) => HttpClientRequest.get(`/api/v2/notification_channels/${id}`).pipe(
    withResponse(options?.config)(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(GetNotificationChannel200),
      "400": decodeError("GetNotificationChannel400", GetNotificationChannel400),
      "401": decodeError("GetNotificationChannel401", GetNotificationChannel401),
      "403": decodeError("GetNotificationChannel403", GetNotificationChannel403),
      "404": decodeError("GetNotificationChannel404", GetNotificationChannel404),
      "500": decodeError("GetNotificationChannel500", GetNotificationChannel500),
      orElse: unexpectedStatus
    }))
  ),
    "UpdateNotificationChannel": (id, options) => HttpClientRequest.put(`/api/v2/notification_channels/${id}`).pipe(
    HttpClientRequest.bodyJsonUnsafe(options.payload),
    withResponse(options.config)(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(UpdateNotificationChannel200),
      "400": decodeError("UpdateNotificationChannel400", UpdateNotificationChannel400),
      "401": decodeError("UpdateNotificationChannel401", UpdateNotificationChannel401),
      "403": decodeError("UpdateNotificationChannel403", UpdateNotificationChannel403),
      "404": decodeError("UpdateNotificationChannel404", UpdateNotificationChannel404),
      "500": decodeError("UpdateNotificationChannel500", UpdateNotificationChannel500),
      orElse: unexpectedStatus
    }))
  ),
    "DeleteNotificationChannel": (id, options) => HttpClientRequest.delete(`/api/v2/notification_channels/${id}`).pipe(
    withResponse(options?.config)(HttpClientResponse.matchStatus({
      "400": decodeError("DeleteNotificationChannel400", DeleteNotificationChannel400),
      "401": decodeError("DeleteNotificationChannel401", DeleteNotificationChannel401),
      "403": decodeError("DeleteNotificationChannel403", DeleteNotificationChannel403),
      "404": decodeError("DeleteNotificationChannel404", DeleteNotificationChannel404),
      "500": decodeError("DeleteNotificationChannel500", DeleteNotificationChannel500),
      "204": () => Effect.void,
      orElse: unexpectedStatus
    }))
  ),
    "TestNotificationChannel": (options) => HttpClientRequest.post(`/api/v2/notification_channels/test`).pipe(
    HttpClientRequest.bodyJsonUnsafe(options.payload),
    withResponse(options.config)(HttpClientResponse.matchStatus({
      "400": decodeError("TestNotificationChannel400", TestNotificationChannel400),
      "401": decodeError("TestNotificationChannel401", TestNotificationChannel401),
      "403": decodeError("TestNotificationChannel403", TestNotificationChannel403),
      "500": decodeError("TestNotificationChannel500", TestNotificationChannel500),
      "204": () => Effect.void,
      orElse: unexpectedStatus
    }))
  ),
...
*/
readonly "ListNotificationChannels": <Config extends OperationConfig>(options: { readonly params?: typeof ListNotificationChannelsParams.Encoded | undefined; readonly config?: Config | undefined } | undefined) => Effect.Effect<WithOptionalResponse<typeof ListNotificationChannels200.Type, Config>, HttpClientError.HttpClientError | SchemaError | SigNozError<"ListNotificationChannels400", typeof ListNotificationChannels400.Type> | SigNozError<"ListNotificationChannels401", typeof ListNotificationChannels401.Type> | SigNozError<"ListNotificationChannels403", typeof ListNotificationChannels403.Type> | SigNozError<"ListNotificationChannels500", typeof ListNotificationChannels500.Type>>
  /**
* This endpoint creates a notification channel
*/
...
*/
readonly "GetNotificationChannel": <Config extends OperationConfig>(id: string, options: { readonly config?: Config | undefined } | undefined) => Effect.Effect<WithOptionalResponse<typeof GetNotificationChannel200.Type, Config>, HttpClientError.HttpClientError | SchemaError | SigNozError<"GetNotificationChannel400", typeof GetNotificationChannel400.Type> | SigNozError<"GetNotificationChannel401", typeof GetNotificationChannel401.Type> | SigNozError<"GetNotificationChannel403", typeof GetNotificationChannel403.Type> | SigNozError<"GetNotificationChannel404", typeof GetNotificationChannel404.Type> | SigNozError<"GetNotificationChannel500", typeof GetNotificationChannel500.Type>>
  /**
...
*/
readonly "UpdateNotificationChannel": <Config extends OperationConfig>(id: string, options: { readonly payload: typeof UpdateNotificationChannelRequestJson.Encoded; readonly config?: Config | undefined }) => Effect.Effect<WithOptionalResponse<typeof UpdateNotificationChannel200.Type, Config>, HttpClientError.HttpClientError | SchemaError | SigNozError<"UpdateNotificationChannel400", typeof UpdateNotificationChannel400.Type> | SigNozError<"UpdateNotificationChannel401", typeof UpdateNotificationChannel401.Type> | SigNozError<"UpdateNotificationChannel403", typeof UpdateNotificationChannel403.Type> | SigNozError<"UpdateNotificationChannel404", typeof UpdateNotificationChannel404.Type> | SigNozError<"UpdateNotificationChannel500", typeof UpdateNotificationChannel500.Type>>
  /**
* This endpoint deletes a notification channel by ID
*/
readonly "DeleteNotificationChannel": <Config extends OperationConfig>(id: string, options: { readonly config?: Config | undefined } | undefined) => Effect.Effect<WithOptionalResponse<void, Config>, HttpClientError.HttpClientError | SchemaError | SigNozError<"DeleteNotificationChannel400", typeof DeleteNotificationChannel400.Type> | SigNozError<"DeleteNotificationChannel401", typeof DeleteNotificationChannel401.Type> | SigNozError<"DeleteNotificationChannel403", typeof DeleteNotificationChannel403.Type> | SigNozError<"DeleteNotificationChannel404", typeof DeleteNotificationChannel404.Type> | SigNozError<"DeleteNotificationChannel500", typeof DeleteNotificationChannel500.Type>>
  /**
...
*/
readonly "TestNotificationChannel": <Config extends OperationConfig>(options: { readonly payload: typeof TestNotificationChannelRequestJson.Encoded; readonly config?: Config | undefined }) => Effect.Effect<WithOptionalResponse<void, Config>, HttpClientError.HttpClientError | SchemaError | SigNozError<"TestNotificationChannel400", typeof TestNotificationChannel400.Type> | SigNozError<"TestNotificationChannel401", typeof TestNotificationChannel401.Type> | SigNozError<"TestNotificationChannel403", typeof TestNotificationChannel403.Type> | SigNozError<"TestNotificationChannel500", typeof TestNotificationChannel500.Type>>
  /**
