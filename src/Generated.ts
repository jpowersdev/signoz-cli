...
export type AuthtypesRole = { readonly "createdAt"?: string, readonly "description": string, readonly "id": string, readonly "name": string, readonly "orgId": string, readonly "type": string, readonly "updatedAt"?: string }
export const AuthtypesRole = Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })), "description": Schema.String, "id": Schema.String, "name": Schema.String, "orgId": Schema.String, "type": Schema.String, "updatedAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })) })
...
export type DashboardLink = { readonly "name"?: string, readonly "renderVariables"?: boolean, readonly "targetBlank"?: boolean, readonly "tooltip"?: string, readonly "url"?: string }
export const DashboardLink = Schema.Struct({ "name": Schema.optionalKey(Schema.String), "renderVariables": Schema.optionalKey(Schema.Boolean), "targetBlank": Schema.optionalKey(Schema.Boolean), "tooltip": Schema.optionalKey(Schema.String), "url": Schema.optionalKey(Schema.String) })
...
export type Querybuildertypesv5FunctionArg = { readonly "name"?: string, readonly "value"?: number | string }
export const Querybuildertypesv5FunctionArg = Schema.Struct({ "name": Schema.optionalKey(Schema.String), "value": Schema.optionalKey(Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.String], { mode: "oneOf" })) })
...
export type Querybuildertypesv5LogAggregation = { readonly "alias"?: string, readonly "expression"?: string }
export const Querybuildertypesv5LogAggregation = Schema.Struct({ "alias": Schema.optionalKey(Schema.String), "expression": Schema.optionalKey(Schema.String) })
...
export type Querybuildertypesv5TraceAggregation = { readonly "alias"?: string, readonly "expression"?: string }
export const Querybuildertypesv5TraceAggregation = Schema.Struct({ "alias": Schema.optionalKey(Schema.String), "expression": Schema.optionalKey(Schema.String) })
...
export const TelemetrytypesSource = Schema.Literal("meter")
...
export type InframonitoringtypesNamespaceRecord = { readonly "meta": {  }, readonly "namespaceCPU": number, readonly "namespaceMemory": number, readonly "namespaceName": string, readonly "podCountsByPhase": InframonitoringtypesPodCountsByPhase, readonly "podCountsByStatus": InframonitoringtypesPodCountsByStatus }
export const InframonitoringtypesNamespaceRecord = Schema.Struct({ "meta": Schema.Union([Schema.Struct({  })]), "namespaceCPU": Schema.Number.annotate({ "format": "double" }).check(Schema.isFinite()), "namespaceMemory": Schema.Number.annotate({ "format": "double" }).check(Schema.isFinite()), "namespaceName": Schema.String, "podCountsByPhase": InframonitoringtypesPodCountsByPhase, "podCountsByStatus": InframonitoringtypesPodCountsByStatus })
...
export type Querybuildertypesv5Function = { readonly "args"?: ReadonlyArray<Querybuildertypesv5FunctionArg>, readonly "name"?: Querybuildertypesv5FunctionName }
export const Querybuildertypesv5Function = Schema.Struct({ "args": Schema.optionalKey(Schema.Array(Querybuildertypesv5FunctionArg)), "name": Schema.optionalKey(Querybuildertypesv5FunctionName) })
...
export type Querybuildertypesv5MetricAggregation = { readonly "comparisonSpaceAggregationParam"?: MetrictypesComparisonSpaceAggregationParam, readonly "metricName"?: string, readonly "reduceTo"?: Querybuildertypesv5ReduceTo, readonly "spaceAggregation"?: MetrictypesSpaceAggregation, readonly "temporality"?: MetrictypesTemporality, readonly "timeAggregation"?: MetrictypesTimeAggregation }
export const Querybuildertypesv5MetricAggregation = Schema.Struct({ "comparisonSpaceAggregationParam": Schema.optionalKey(MetrictypesComparisonSpaceAggregationParam), "metricName": Schema.optionalKey(Schema.String), "reduceTo": Schema.optionalKey(Querybuildertypesv5ReduceTo), "spaceAggregation": Schema.optionalKey(MetrictypesSpaceAggregation), "temporality": Schema.optionalKey(MetrictypesTemporality), "timeAggregation": Schema.optionalKey(MetrictypesTimeAggregation) })
...
export type RuletypesRenotify = { readonly "alertStates"?: ReadonlyArray<RuletypesAlertState>, readonly "enabled"?: boolean, readonly "interval"?: string }
export const RuletypesRenotify = Schema.Struct({ "alertStates": Schema.optionalKey(Schema.Array(RuletypesAlertState)), "enabled": Schema.optionalKey(Schema.Boolean), "interval": Schema.optionalKey(Schema.String) })
...
export type Querybuildertypesv5GroupByKey = { readonly "description"?: string, readonly "fieldContext"?: TelemetrytypesFieldContext, readonly "fieldDataType"?: TelemetrytypesFieldDataType, readonly "name": string, readonly "signal"?: TelemetrytypesSignal, readonly "unit"?: string }
export const Querybuildertypesv5GroupByKey = Schema.Struct({ "description": Schema.optionalKey(Schema.String), "fieldContext": Schema.optionalKey(TelemetrytypesFieldContext), "fieldDataType": Schema.optionalKey(TelemetrytypesFieldDataType), "name": Schema.String, "signal": Schema.optionalKey(TelemetrytypesSignal), "unit": Schema.optionalKey(Schema.String) })
...
export type DashboardtypesListedDashboardForUserV2 = { readonly "createdAt"?: string, readonly "createdBy"?: string, readonly "id": string, readonly "image"?: string, readonly "locked": boolean, readonly "name": string, readonly "orgId": string, readonly "pinned": boolean, readonly "schemaVersion": string, readonly "source": DashboardtypesSource, readonly "spec": DashboardtypesListedDashboardV2Spec, readonly "tags": ReadonlyArray<TagtypesGettableTag>, readonly "updatedAt"?: string, readonly "updatedBy"?: string }
export const DashboardtypesListedDashboardForUserV2 = Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })), "createdBy": Schema.optionalKey(Schema.String), "id": Schema.String, "image": Schema.optionalKey(Schema.String), "locked": Schema.Boolean, "name": Schema.String, "orgId": Schema.String, "pinned": Schema.Boolean, "schemaVersion": Schema.String, "source": DashboardtypesSource, "spec": DashboardtypesListedDashboardV2Spec, "tags": Schema.Array(TagtypesGettableTag), "updatedAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })), "updatedBy": Schema.optionalKey(Schema.String) })
export type DashboardtypesListedDashboardV2 = { readonly "createdAt"?: string, readonly "createdBy"?: string, readonly "id": string, readonly "image"?: string, readonly "locked": boolean, readonly "name": string, readonly "orgId": string, readonly "schemaVersion": string, readonly "source": DashboardtypesSource, readonly "spec": DashboardtypesListedDashboardV2Spec, readonly "tags": ReadonlyArray<TagtypesGettableTag>, readonly "updatedAt"?: string, readonly "updatedBy"?: string }
export const DashboardtypesListedDashboardV2 = Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })), "createdBy": Schema.optionalKey(Schema.String), "id": Schema.String, "image": Schema.optionalKey(Schema.String), "locked": Schema.Boolean, "name": Schema.String, "orgId": Schema.String, "schemaVersion": Schema.String, "source": DashboardtypesSource, "spec": DashboardtypesListedDashboardV2Spec, "tags": Schema.Array(TagtypesGettableTag), "updatedAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })), "updatedBy": Schema.optionalKey(Schema.String) })
...
export type DashboardtypesDatasourceSpec = { readonly "default"?: boolean, readonly "display"?: CommonDisplay, readonly "plugin"?: DashboardtypesDatasourcePlugin }
export const DashboardtypesDatasourceSpec = Schema.Struct({ "default": Schema.optionalKey(Schema.Boolean), "display": Schema.optionalKey(CommonDisplay), "plugin": Schema.optionalKey(DashboardtypesDatasourcePlugin) })
...
export const RuletypesNotificationSettings = Schema.Struct({ "groupBy": Schema.optionalKey(Schema.Array(Schema.String)), "newGroupEvalDelay": Schema.optionalKey(Schema.String), "renotify": Schema.optionalKey(RuletypesRenotify), "usePolicy": Schema.optionalKey(Schema.Boolean) })
...
export type SpantypesSpanMapper = { readonly "config": SpantypesSpanMapperConfig, readonly "createdAt"?: string, readonly "createdBy"?: string, readonly "enabled": boolean, readonly "fieldContext": SpantypesFieldContext, readonly "group_id": string, readonly "id": string, readonly "name": string, readonly "updatedAt"?: string, readonly "updatedBy"?: string }
export const SpantypesSpanMapper = Schema.Struct({ "config": SpantypesSpanMapperConfig, "createdAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })), "createdBy": Schema.optionalKey(Schema.String), "enabled": Schema.Boolean, "fieldContext": SpantypesFieldContext, "group_id": Schema.String, "id": Schema.String, "name": Schema.String, "updatedAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })), "updatedBy": Schema.optionalKey(Schema.String) })
...
export type DashboardtypesListPanelSpec = { readonly "selectFields"?: ReadonlyArray<TelemetrytypesTelemetryFieldKey> }
export const DashboardtypesListPanelSpec = Schema.Struct({ "selectFields": Schema.optionalKey(Schema.Array(TelemetrytypesTelemetryFieldKey)) })
...
export type Querybuildertypesv5QueryBuilderFormula = { readonly "disabled"?: boolean, readonly "expression"?: string, readonly "functions"?: ReadonlyArray<Querybuildertypesv5Function>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "name"?: string, readonly "order"?: ReadonlyArray<Querybuildertypesv5OrderBy> }
export const Querybuildertypesv5QueryBuilderFormula = Schema.Struct({ "disabled": Schema.optionalKey(Schema.Boolean), "expression": Schema.optionalKey(Schema.String), "functions": Schema.optionalKey(Schema.Array(Querybuildertypesv5Function)), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "name": Schema.optionalKey(Schema.String), "order": Schema.optionalKey(Schema.Array(Querybuildertypesv5OrderBy)) })
export type Querybuildertypesv5QueryBuilderTraceOperator = { readonly "aggregations"?: ReadonlyArray<Querybuildertypesv5TraceAggregation>, readonly "cursor"?: string, readonly "disabled"?: boolean, readonly "expression"?: string, readonly "filter"?: Querybuildertypesv5Filter, readonly "functions"?: ReadonlyArray<Querybuildertypesv5Function>, readonly "groupBy"?: ReadonlyArray<Querybuildertypesv5GroupByKey>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "name"?: string, readonly "offset"?: number, readonly "order"?: ReadonlyArray<Querybuildertypesv5OrderBy>, readonly "returnSpansFrom"?: string, readonly "selectFields"?: ReadonlyArray<TelemetrytypesTelemetryFieldKey>, readonly "stepInterval"?: Querybuildertypesv5Step }
export const Querybuildertypesv5QueryBuilderTraceOperator = Schema.Struct({ "aggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5TraceAggregation)), "cursor": Schema.optionalKey(Schema.String), "disabled": Schema.optionalKey(Schema.Boolean), "expression": Schema.optionalKey(Schema.String), "filter": Schema.optionalKey(Querybuildertypesv5Filter), "functions": Schema.optionalKey(Schema.Array(Querybuildertypesv5Function)), "groupBy": Schema.optionalKey(Schema.Array(Querybuildertypesv5GroupByKey)), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "name": Schema.optionalKey(Schema.String), "offset": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "order": Schema.optionalKey(Schema.Array(Querybuildertypesv5OrderBy)), "returnSpansFrom": Schema.optionalKey(Schema.String), "selectFields": Schema.optionalKey(Schema.Array(TelemetrytypesTelemetryFieldKey)), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) })
export type Querybuildertypesv5SecondaryAggregation = { readonly "alias"?: string, readonly "expression"?: string, readonly "groupBy"?: ReadonlyArray<Querybuildertypesv5GroupByKey>, readonly "limit"?: number, readonly "limitBy"?: Querybuildertypesv5LimitBy, readonly "order"?: ReadonlyArray<Querybuildertypesv5OrderBy>, readonly "stepInterval"?: Querybuildertypesv5Step }
export const Querybuildertypesv5SecondaryAggregation = Schema.Struct({ "alias": Schema.optionalKey(Schema.String), "expression": Schema.optionalKey(Schema.String), "groupBy": Schema.optionalKey(Schema.Array(Querybuildertypesv5GroupByKey)), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "limitBy": Schema.optionalKey(Querybuildertypesv5LimitBy), "order": Schema.optionalKey(Schema.Array(Querybuildertypesv5OrderBy)), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) })
...
export type MetricsexplorertypesInspectMetricsResponse = { readonly "series": ReadonlyArray<{ readonly "labels"?: ReadonlyArray<Querybuildertypesv5Label>, readonly "values"?: ReadonlyArray<{ readonly "bucket"?: Querybuildertypesv5Bucket, readonly "partial"?: boolean, readonly "timestamp"?: number, readonly "value"?: number, readonly "values"?: ReadonlyArray<number> }> }> }
export const MetricsexplorertypesInspectMetricsResponse = Schema.Struct({ "series": Schema.Union([Schema.Array(Schema.Struct({ "labels": Schema.optionalKey(Schema.Array(Querybuildertypesv5Label)), "values": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "bucket": Schema.optionalKey(Querybuildertypesv5Bucket), "partial": Schema.optionalKey(Schema.Boolean), "timestamp": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "value": Schema.optionalKey(Schema.Number.annotate({ "format": "double" }).check(Schema.isFinite())), "values": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "double" }).check(Schema.isFinite()))) }))])) }))]) })
export type Querybuildertypesv5TimeSeries = { readonly "labels"?: ReadonlyArray<Querybuildertypesv5Label>, readonly "values"?: ReadonlyArray<{ readonly "bucket"?: Querybuildertypesv5Bucket, readonly "partial"?: boolean, readonly "timestamp"?: number, readonly "value"?: number, readonly "values"?: ReadonlyArray<number> }> }
...
export type DashboardtypesBuilderQuerySpec = { readonly "aggregations"?: ReadonlyArray<Querybuildertypesv5LogAggregation>, readonly "cursor"?: string, readonly "disabled"?: boolean, readonly "filter"?: Querybuildertypesv5Filter, readonly "functions"?: ReadonlyArray<Querybuildertypesv5Function>, readonly "groupBy"?: ReadonlyArray<Querybuildertypesv5GroupByKey>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "limitBy"?: Querybuildertypesv5LimitBy, readonly "name"?: string, readonly "offset"?: number, readonly "order"?: ReadonlyArray<Querybuildertypesv5OrderBy>, readonly "secondaryAggregations"?: ReadonlyArray<Querybuildertypesv5SecondaryAggregation>, readonly "selectFields"?: ReadonlyArray<TelemetrytypesTelemetryFieldKey>, readonly "signal": "logs", readonly "source"?: TelemetrytypesSource, readonly "stepInterval"?: Querybuildertypesv5Step } | { readonly "aggregations"?: ReadonlyArray<Querybuildertypesv5MetricAggregation>, readonly "cursor"?: string, readonly "disabled"?: boolean, readonly "filter"?: Querybuildertypesv5Filter, readonly "functions"?: ReadonlyArray<Querybuildertypesv5Function>, readonly "groupBy"?: ReadonlyArray<Querybuildertypesv5GroupByKey>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "limitBy"?: Querybuildertypesv5LimitBy, readonly "name"?: string, readonly "offset"?: number, readonly "order"?: ReadonlyArray<Querybuildertypesv5OrderBy>, readonly "secondaryAggregations"?: ReadonlyArray<Querybuildertypesv5SecondaryAggregation>, readonly "selectFields"?: ReadonlyArray<TelemetrytypesTelemetryFieldKey>, readonly "signal": "metrics", readonly "source"?: TelemetrytypesSource, readonly "stepInterval"?: Querybuildertypesv5Step } | { readonly "aggregations"?: ReadonlyArray<Querybuildertypesv5TraceAggregation>, readonly "cursor"?: string, readonly "disabled"?: boolean, readonly "filter"?: Querybuildertypesv5Filter, readonly "functions"?: ReadonlyArray<Querybuildertypesv5Function>, readonly "groupBy"?: ReadonlyArray<Querybuildertypesv5GroupByKey>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "limitBy"?: Querybuildertypesv5LimitBy, readonly "name"?: string, readonly "offset"?: number, readonly "order"?: ReadonlyArray<Querybuildertypesv5OrderBy>, readonly "secondaryAggregations"?: ReadonlyArray<Querybuildertypesv5SecondaryAggregation>, readonly "selectFields"?: ReadonlyArray<TelemetrytypesTelemetryFieldKey>, readonly "signal": "traces", readonly "source"?: TelemetrytypesSource, readonly "stepInterval"?: Querybuildertypesv5Step }
export const DashboardtypesBuilderQuerySpec = Schema.Union([Schema.Struct({ "aggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5LogAggregation)), "cursor": Schema.optionalKey(Schema.String), "disabled": Schema.optionalKey(Schema.Boolean), "filter": Schema.optionalKey(Querybuildertypesv5Filter), "functions": Schema.optionalKey(Schema.Array(Querybuildertypesv5Function)), "groupBy": Schema.optionalKey(Schema.Array(Querybuildertypesv5GroupByKey)), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "limitBy": Schema.optionalKey(Querybuildertypesv5LimitBy), "name": Schema.optionalKey(Schema.String), "offset": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "order": Schema.optionalKey(Schema.Array(Querybuildertypesv5OrderBy)), "secondaryAggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5SecondaryAggregation)), "selectFields": Schema.optionalKey(Schema.Array(TelemetrytypesTelemetryFieldKey)), "signal": Schema.Literal("logs"), "source": Schema.optionalKey(TelemetrytypesSource), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) }), Schema.Struct({ "aggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5MetricAggregation)), "cursor": Schema.optionalKey(Schema.String), "disabled": Schema.optionalKey(Schema.Boolean), "filter": Schema.optionalKey(Querybuildertypesv5Filter), "functions": Schema.optionalKey(Schema.Array(Querybuildertypesv5Function)), "groupBy": Schema.optionalKey(Schema.Array(Querybuildertypesv5GroupByKey)), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "limitBy": Schema.optionalKey(Querybuildertypesv5LimitBy), "name": Schema.optionalKey(Schema.String), "offset": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "order": Schema.optionalKey(Schema.Array(Querybuildertypesv5OrderBy)), "secondaryAggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5SecondaryAggregation)), "selectFields": Schema.optionalKey(Schema.Array(TelemetrytypesTelemetryFieldKey)), "signal": Schema.Literal("metrics"), "source": Schema.optionalKey(TelemetrytypesSource), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) }), Schema.Struct({ "aggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5TraceAggregation)), "cursor": Schema.optionalKey(Schema.String), "disabled": Schema.optionalKey(Schema.Boolean), "filter": Schema.optionalKey(Querybuildertypesv5Filter), "functions": Schema.optionalKey(Schema.Array(Querybuildertypesv5Function)), "groupBy": Schema.optionalKey(Schema.Array(Querybuildertypesv5GroupByKey)), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "limitBy": Schema.optionalKey(Querybuildertypesv5LimitBy), "name": Schema.optionalKey(Schema.String), "offset": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "order": Schema.optionalKey(Schema.Array(Querybuildertypesv5OrderBy)), "secondaryAggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5SecondaryAggregation)), "selectFields": Schema.optionalKey(Schema.Array(TelemetrytypesTelemetryFieldKey)), "signal": Schema.Literal("traces"), "source": Schema.optionalKey(TelemetrytypesSource), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) })], { mode: "oneOf" })
export type Querybuildertypesv5BuilderQuerySpec = { readonly "aggregations"?: ReadonlyArray<Querybuildertypesv5TraceAggregation>, readonly "cursor"?: string, readonly "disabled"?: boolean, readonly "filter"?: Querybuildertypesv5Filter, readonly "functions"?: ReadonlyArray<Querybuildertypesv5Function>, readonly "groupBy"?: ReadonlyArray<Querybuildertypesv5GroupByKey>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "limitBy"?: Querybuildertypesv5LimitBy, readonly "name"?: string, readonly "offset"?: number, readonly "order"?: ReadonlyArray<Querybuildertypesv5OrderBy>, readonly "secondaryAggregations"?: ReadonlyArray<Querybuildertypesv5SecondaryAggregation>, readonly "selectFields"?: ReadonlyArray<TelemetrytypesTelemetryFieldKey>, readonly "signal": "traces", readonly "source"?: TelemetrytypesSource, readonly "stepInterval"?: Querybuildertypesv5Step } | { readonly "aggregations"?: ReadonlyArray<Querybuildertypesv5LogAggregation>, readonly "cursor"?: string, readonly "disabled"?: boolean, readonly "filter"?: Querybuildertypesv5Filter, readonly "functions"?: ReadonlyArray<Querybuildertypesv5Function>, readonly "groupBy"?: ReadonlyArray<Querybuildertypesv5GroupByKey>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "limitBy"?: Querybuildertypesv5LimitBy, readonly "name"?: string, readonly "offset"?: number, readonly "order"?: ReadonlyArray<Querybuildertypesv5OrderBy>, readonly "secondaryAggregations"?: ReadonlyArray<Querybuildertypesv5SecondaryAggregation>, readonly "selectFields"?: ReadonlyArray<TelemetrytypesTelemetryFieldKey>, readonly "signal": "logs", readonly "source"?: TelemetrytypesSource, readonly "stepInterval"?: Querybuildertypesv5Step } | { readonly "aggregations"?: ReadonlyArray<Querybuildertypesv5MetricAggregation>, readonly "cursor"?: string, readonly "disabled"?: boolean, readonly "filter"?: Querybuildertypesv5Filter, readonly "functions"?: ReadonlyArray<Querybuildertypesv5Function>, readonly "groupBy"?: ReadonlyArray<Querybuildertypesv5GroupByKey>, readonly "having"?: Querybuildertypesv5Having, readonly "legend"?: string, readonly "limit"?: number, readonly "limitBy"?: Querybuildertypesv5LimitBy, readonly "name"?: string, readonly "offset"?: number, readonly "order"?: ReadonlyArray<Querybuildertypesv5OrderBy>, readonly "secondaryAggregations"?: ReadonlyArray<Querybuildertypesv5SecondaryAggregation>, readonly "selectFields"?: ReadonlyArray<TelemetrytypesTelemetryFieldKey>, readonly "signal": "metrics", readonly "source"?: TelemetrytypesSource, readonly "stepInterval"?: Querybuildertypesv5Step }
export const Querybuildertypesv5BuilderQuerySpec = Schema.Union([Schema.Struct({ "aggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5TraceAggregation)), "cursor": Schema.optionalKey(Schema.String), "disabled": Schema.optionalKey(Schema.Boolean), "filter": Schema.optionalKey(Querybuildertypesv5Filter), "functions": Schema.optionalKey(Schema.Array(Querybuildertypesv5Function)), "groupBy": Schema.optionalKey(Schema.Array(Querybuildertypesv5GroupByKey)), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "limitBy": Schema.optionalKey(Querybuildertypesv5LimitBy), "name": Schema.optionalKey(Schema.String), "offset": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "order": Schema.optionalKey(Schema.Array(Querybuildertypesv5OrderBy)), "secondaryAggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5SecondaryAggregation)), "selectFields": Schema.optionalKey(Schema.Array(TelemetrytypesTelemetryFieldKey)), "signal": Schema.Literal("traces"), "source": Schema.optionalKey(TelemetrytypesSource), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) }), Schema.Struct({ "aggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5LogAggregation)), "cursor": Schema.optionalKey(Schema.String), "disabled": Schema.optionalKey(Schema.Boolean), "filter": Schema.optionalKey(Querybuildertypesv5Filter), "functions": Schema.optionalKey(Schema.Array(Querybuildertypesv5Function)), "groupBy": Schema.optionalKey(Schema.Array(Querybuildertypesv5GroupByKey)), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "limitBy": Schema.optionalKey(Querybuildertypesv5LimitBy), "name": Schema.optionalKey(Schema.String), "offset": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "order": Schema.optionalKey(Schema.Array(Querybuildertypesv5OrderBy)), "secondaryAggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5SecondaryAggregation)), "selectFields": Schema.optionalKey(Schema.Array(TelemetrytypesTelemetryFieldKey)), "signal": Schema.Literal("logs"), "source": Schema.optionalKey(TelemetrytypesSource), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) }), Schema.Struct({ "aggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5MetricAggregation)), "cursor": Schema.optionalKey(Schema.String), "disabled": Schema.optionalKey(Schema.Boolean), "filter": Schema.optionalKey(Querybuildertypesv5Filter), "functions": Schema.optionalKey(Schema.Array(Querybuildertypesv5Function)), "groupBy": Schema.optionalKey(Schema.Array(Querybuildertypesv5GroupByKey)), "having": Schema.optionalKey(Querybuildertypesv5Having), "legend": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "limitBy": Schema.optionalKey(Querybuildertypesv5LimitBy), "name": Schema.optionalKey(Schema.String), "offset": Schema.optionalKey(Schema.Number.check(Schema.isInt())), "order": Schema.optionalKey(Schema.Array(Querybuildertypesv5OrderBy)), "secondaryAggregations": Schema.optionalKey(Schema.Array(Querybuildertypesv5SecondaryAggregation)), "selectFields": Schema.optionalKey(Schema.Array(TelemetrytypesTelemetryFieldKey)), "signal": Schema.Literal("metrics"), "source": Schema.optionalKey(TelemetrytypesSource), "stepInterval": Schema.optionalKey(Querybuildertypesv5Step) })], { mode: "oneOf" })
...
export type AuthtypesRoleWithTransactionGroups = { readonly "createdAt"?: string, readonly "description": string, readonly "id": string, readonly "name": string, readonly "orgId": string, readonly "transactionGroups": AuthtypesTransactionGroups, readonly "type": string, readonly "updatedAt"?: string }
export const AuthtypesRoleWithTransactionGroups = Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })), "description": Schema.String, "id": Schema.String, "name": Schema.String, "orgId": Schema.String, "transactionGroups": AuthtypesTransactionGroups, "type": Schema.String, "updatedAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })) })
...
export type DashboardtypesPanelSpec = { readonly "display": DashboardtypesDisplay, readonly "links"?: ReadonlyArray<DashboardLink>, readonly "plugin": DashboardtypesPanelPlugin, readonly "queries": ReadonlyArray<DashboardtypesQuery> }
export const DashboardtypesPanelSpec = Schema.Struct({ "display": DashboardtypesDisplay, "links": Schema.optionalKey(Schema.Array(DashboardLink)), "plugin": DashboardtypesPanelPlugin, "queries": Schema.Array(DashboardtypesQuery) })
...
export type DashboardtypesDashboardSpec = { readonly "datasources"?: { readonly [x: string]: DashboardtypesDatasourceSpec }, readonly "display": DashboardtypesDisplay, readonly "duration"?: string, readonly "layouts": ReadonlyArray<DashboardtypesLayout>, readonly "links"?: ReadonlyArray<DashboardLink>, readonly "panels": { readonly [x: string]: DashboardtypesPanel }, readonly "refreshInterval"?: string, readonly "variables": ReadonlyArray<DashboardtypesVariable> }
export const DashboardtypesDashboardSpec = Schema.Struct({ "datasources": Schema.optionalKey(Schema.Record(Schema.String, DashboardtypesDatasourceSpec)), "display": DashboardtypesDisplay, "duration": Schema.optionalKey(Schema.String), "layouts": Schema.Array(DashboardtypesLayout), "links": Schema.optionalKey(Schema.Array(DashboardLink)), "panels": Schema.Record(Schema.String, DashboardtypesPanel), "refreshInterval": Schema.optionalKey(Schema.String), "variables": Schema.Array(DashboardtypesVariable) })
...
export type ListRoles200 = { readonly "data": ReadonlyArray<AuthtypesRole>, readonly "status": string }
export const ListRoles200 = Schema.Struct({ "data": Schema.Array(AuthtypesRole), "status": Schema.String })
...
export type GetRole200 = { readonly "data": AuthtypesRoleWithTransactionGroups, readonly "status": string }
export const GetRole200 = Schema.Struct({ "data": AuthtypesRoleWithTransactionGroups, "status": Schema.String })
...
export type GetServiceAccountRoles200 = { readonly "data": ReadonlyArray<{ readonly "createdAt"?: string, readonly "description": string, readonly "id": string, readonly "name": string, readonly "orgId": string, readonly "type": string, readonly "updatedAt"?: string }>, readonly "status": string }
export const GetServiceAccountRoles200 = Schema.Struct({ "data": Schema.Union([Schema.Array(Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })), "description": Schema.String, "id": Schema.String, "name": Schema.String, "orgId": Schema.String, "type": Schema.String, "updatedAt": Schema.optionalKey(Schema.String.annotate({ "format": "date-time" })) }))]), "status": Schema.String })
...
export type ListSpanMappers200 = { readonly "data": SpantypesGettableSpanMapperGroups, readonly "status": string }
export const ListSpanMappers200 = Schema.Struct({ "data": SpantypesGettableSpanMapperGroups, "status": Schema.String })
